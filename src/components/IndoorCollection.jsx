...
const allItems = [
  {
    title: 'Pachira',
    desc: `Surnommé arbre à bonheur, le Pachira apporte une énergie douce et généreuse dans chaque pièce.`,
  ...
  {
    title: 'Bonsaï',
    desc: `Un arbre entier, dans la paume de la main. Le bonsaï est une invitation à ralentir, à observer, à prendre soin. `,
  ...
  {
    title: 'Calathea',
    desc: `Ses feuilles sont des tableaux. Nervures contrastées, reflets violets, motifs qui semblent peints à la main.`,
  ...
  {
    title: 'Ficus',
    desc: `Un grand classique qui n'a rien perdu de son élégance. Le Ficus structure un espace, adoucit une pièce trop angulaire.`,
  ...
  {
    title: 'Monstera',
    desc: `Impossible de passer à côté. Avec ses grandes feuilles découpées comme à la main, le Monstera est devenu une icône et il le mérite.`,
  ...
  {
    title: 'Orchidée',
    desc: `Elle a l'air fragile, mais elle sait durer. L'orchidée est la plante des attentions silencieuses.`,
